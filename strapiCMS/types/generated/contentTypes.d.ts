...
export interface ApiAboutAbout extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    eventureAboutUsDescription: Schema.Attribute.Blocks;
    aboutUsHeadline1: Schema.Attribute.String;
    eventureAboutUsDescription2: Schema.Attribute.Blocks;
    aboutUsHeadline2: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    publishedAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiEmployeeEmployee extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    employeeTitle: Schema.Attribute.String;
    employeeImage: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    employeeAltText: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    publishedAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiEventEvent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    eventPicture: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    host: Schema.Attribute.Relation<'manyToOne', 'api::host.host'>;
    eventPrice: Schema.Attribute.Integer;
    eventVenue: Schema.Attribute.String;
    eventFeatured: Schema.Attribute.Boolean;
    eventGenre: Schema.Attribute.Enumeration<
      [
        'Music',
        'Food',
        'Sport',
...
export interface ApiHeaderHeader extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    headerInfo: Schema.Attribute.Blocks;
    createdAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    publishedAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiHostHost extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    hostAvatar: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios',
      true
    >;
    hostContact: Schema.Attribute.String;
